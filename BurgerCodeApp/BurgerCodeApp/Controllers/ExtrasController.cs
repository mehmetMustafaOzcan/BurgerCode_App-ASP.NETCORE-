...
namespace BurgerCodeApp.Controllers
{
    public class ExtrasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ExtraId,Name,Description")] Extra extra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExtraId,Name,Description")] Extra extra)
        {
            if (id != extra.ExtraId)
            {
                return NotFound();
