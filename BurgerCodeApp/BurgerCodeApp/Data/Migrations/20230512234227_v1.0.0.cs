    ...
    public partial class v100 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraDetails", x => new { x.BasketID, x.ExtraId });
                    table.ForeignKey(
                        name: "FK_ExtraDetails_Baskets",
                        column: x => x.BasketID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenüPrice = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasketDetails", x => new { x.BasketId, x.MenuId });
                    table.ForeignKey(
